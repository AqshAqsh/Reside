        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-5 col-md-5 mb-4 order-lg-2 order-md-2 order-1">
                    <img src="about/p1.jpg" alt="" class="w-100">
                </div>
            </div>
        </div>
        <div class="container mt-5">
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4 px-4">
                   ...
                   <img src="about/hotel.svg" alt=""  width="70px">
                   <h2 class="mt-3">100+ Rooms</h2>
                   </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4 px-4">
                   <div class="bg-white rounded shdow p-4 border-top border-4 text-center box">
                   <img src="about/staff.svg" alt=""  width="70px">
                   <h2 class="mt-3">100+ staffs</h2>
                   </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4 px-4">
                   <div class="bg-white rounded shdow p-4 border-top border-4 text-center box">
                   <img src="about/customers.svg" alt=""  width="70px">
                   <h2 class="mt-3">200+ customers</h2>
                   </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4 px-4">
                   <div class="bg-white rounded shdow p-4 border-top border-4 text-center box">
                   <img src="about/rating.svg" alt=""  width="70px">
            ...
            <div class="swiper mySwiper ">
                <div class="swiper-wrapper mb-5">
                    <div class="swiper-slide bg-white text-center overflow-hidden rounded">
                        <img src="about/p.jpg" alt="" class="w-100" >
